  ...
  <Layout>
    <div class="pt-8 md:pt-16">
      <div class="flex flex-col items-center">
        ...
        <!-- <h1 class="text-4xl text-center lg:text-5xl"></h1> -->
        <p class="text-xl font-medium text-center">
          A decentralised universal basic income protocol based on personal currencies and self-sovereign web-of-trust identities
          <br />
        ...
        <p class="mt-8 text-center">
          ...
          >Start building apps on top of your personal currency protocol</span>.
        </p>
      </div>
